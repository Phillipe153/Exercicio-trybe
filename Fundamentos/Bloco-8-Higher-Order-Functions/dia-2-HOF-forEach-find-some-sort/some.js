...
const temMenorDeIdade = arrayIdades2.some((valor) =>  valor < 18);

// console.log(temMenorDeIdade);
// if (temMenorDeIdade === true){console.log ('ChocoTrybe, melhor que console.log')}
// else {console.log("Beba Trybeer, suave como um log de erro vazio")}

const mentoria = estudantes.some((valor) => valor.status < 80)
if (mentoria === true){console.log ('Bora pra mentoria de projetos!')}
