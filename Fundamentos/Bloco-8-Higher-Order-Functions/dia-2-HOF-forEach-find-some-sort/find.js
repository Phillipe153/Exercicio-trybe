...
const estudantes = [
  ...
  const aprovado = estudantes.find((valor) => valor.status >80 );
  console.log (`Olá ${aprovado.nome}, parabéns por ter finalizado 100% do projeto, o que vc acha de ajudar outras pessoas da turma a tbm entregarem o projeto?`);