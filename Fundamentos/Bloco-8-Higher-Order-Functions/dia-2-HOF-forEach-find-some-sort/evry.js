...
const temMenorDeIdade = arrayIdades.every((valor) =>  valor > 18);

console.log(temMenorDeIdade);
if (temMenorDeIdade === false){console.log ('ChocoTrybe, melhor que console.log')}
else {console.log("Beba Trybeer, suave como um log de erro vazio")}
console.log(" ");

const mentoria = estudantes.every((valor) => valor.status > 80)
if (mentoria === false){console.log ('Bora pra mentoria de projetos!')}
else {console.log("Pode abrir o suco de laranja que temos 100% de aprovação!")}
